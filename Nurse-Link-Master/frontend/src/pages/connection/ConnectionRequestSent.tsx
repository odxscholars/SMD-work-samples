...
import ConnectionRequestCard from "../../components/connectionComponents/connectionRequestSentCard"
                            ...
                            <div className="flex flex-col main-section w-3/4">
                                <div className="mb-5">
                                    <p style={{ fontFamily: "Poppins", color: "#053B50", fontSize: "3rem", fontWeight: 900}}>
                                        {nurse?.connectionSent?.length} Connections Requests
                                    </p>
                                </div>
                                <div className="grid grid-cols-3 gap-4 w-100">
                                    {nurse?.connectionSent?.map((connectionId, index) => (
